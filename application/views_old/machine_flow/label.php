                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" placeholder="" value="<?php echo $job['WO_no'] ?>" name="WO_no" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" placeholder=""  value="<?php echo $job['Job_Description'] ?>" readonly name="Job_Description">
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        <center><h4>Cutting Report </h4></center>
                                        <div class="form-group row">
                                            <div class="form-group col-lg-6">
                                                <label for="example-text-input" class="col-sm-4">Machine</label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control" placeholder="" value="<?php echo $job['machine_Name'] ?>" readonly name="machine_Name">
                                                </div>
                                            </div>
                                            <div class="form-group col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" placeholder="" name="paper_size">
                                                </div>
                                            </div>
                                        ...
                                        <hr>
                                        <center><h4>Batch manufacturing Check List </h4></center>
                                         <div class="form-group row">
                                            <div class="form-group col-lg-6">
                                               ...
                                               <div class="col-sm-9">
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio9" value="Yes" name="machine_cleaning" checked="">
                                                        <label for="inlineRadio9"> Yes </label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio10" value="No" name="machine_cleaning">
                                            ...
                                            <div class="form-group col-lg-6">
                                               ...
                                               <div class="col-sm-9">
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio11" value="Yes" name="size_set" checked="">
                                                        <label for="inlineRadio11"> Yes </label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio12" value="No" name="size_set">
                                        ...
                                        <div class="form-group row">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" placeholder="" name="total_production">
                                                </div>
                                            </div>
                                            <div class="form-group col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            <div class="form-group col-lg-6">
                                                <label for="example-text-input" class="col-sm-4">Packers Name :</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" placeholder="" name="packers_name">
                                                </div>
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="example-text-input" class="col-sm-4">Master carton # </label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control" placeholder="" name="master_carton">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                <label for="example-text-input" class="col-sm-4">Packing Size </label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" placeholder="" name="packing_Size">
                                                </div>
                                            </div>
