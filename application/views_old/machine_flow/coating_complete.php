    ...
    <div class=content>
        <div class=content-header>
            ...
            <div class=header-title>
                <h1>Coating Machine Form</h1>
                <small></small>
                <ol class=breadcrumb>
                    <li><i class=pe-7s-home></i> Home</li>
                    <li class="active">Coating Machine Form</li>
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control"  name="process">
                                                        ...
                                                        <option value="Coating" <?php if($detail['process'] == 'Coating') echo 'selected' ?>>Coating</option>
                                                        <option value="Coating" <?php if($detail['process'] == 'Coating') echo 'selected' ?>>Coating</option>
                                                    </select>
                                                </div>
                                            </div>
