...
<td><?php echo $module["status"] ?></td>
                                                    ...
                                                    <td>
                                                        <?php 
                                                            if ($module['reports'] == 0) {
                                                        ?>
                                                        <a href="<?php echo base_url() ?>coating/report_submit/<?php echo $module["id"] ?>"><img src="<?php echo base_url() ?>assets/icons/report_submit.png" title="Report Submit" alt="Report Submit" width="25" height="25"></a>
                                                        <?php 
                                                            }?>
