    ...
    <div class=content>
        <div class=content-header>
            ...
            <div class=header-title>
                <h1>View Coating Machine</h1>
                <small></small>
                <ol class=breadcrumb>
                    <li>
                        <i class=pe-7s-home></i> Home</li>
                    <li class="active">View Coating Machine</li>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tr>
                                            <td colspan="3">Process : <div class="radio radio-inline">
                                                        <input type="radio" disabled=""  id="inlineradio3" name="process" value="Cutting" <?php if($data['process'] == 'Coating') echo 'checked' ?>>
