...
<div id="page-wrapper">
    ...
    <div class="content">
        ...
        <form method="post" action="<?php echo base_url() ?>purchases/insert" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9"><input class="form-control" name="Attach_Document" type="file" value="" id="example-text-input" placeholder=""></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9"><input class="form-control" name="Order_Tax" type="text" value="" id="example-text-input" placeholder=""></div>

                            </div>
                            <div class="form-group row">

                                <label for="example-text-input" class="col-sm-3 col-form-label">Discount (5/5$)</label>
                                <div class="col-sm-9"><input class="form-control" name="Discount" type="text" value="" id="example-text-input" placeholder=""></div>

                            </div>
                            <div class="form-group row">

                                <label for="example-text-input" class="col-sm-3 col-form-label">Shipping</label>
                                <div class="col-sm-9"><input class="form-control" name="Shipping" type="text" value="" id="example-text-input" placeholder=""></div>

                            </div>
                            <div class="form-group row">

                                <label for="example-text-input" class="col-sm-3 col-form-label">Payment Term</label>
                                <div class="col-sm-9"><input class="form-control" name="Payment_Term" type="text" value="" id="example-text-input" placeholder=""></div>
