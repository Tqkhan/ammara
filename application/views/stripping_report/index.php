                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                        <a href="<?php echo base_url() ?>requisition/order/<?php echo $o["WO_no"] ?>/Stripping_Report?redirect=<?php echo $url ?>"><img src="<?php echo base_url() ?>assets/icons/create-order.png" title="Order" alt="Order" width="25" height="25"></a>

                                                        <a href="<?php echo base_url() ?>requisition/view_order/<?php echo $o["WO_no"] ?>/Stripping_Report" target="_blank"><img src="<?php echo base_url() ?>assets/icons/view_order.png" title="View Order" alt="View Order" width="25" height="25"></a>
                                                        <?php } ?>
                                                        ...
                                                        <?php 
                                                            if ($o['con'] == 0) {
                                                        ?>
                                                        <a href="<?php echo base_url('machine_flow/stripping_report_start/'.$o['id'].'/'.$o['flow_id']) ?>"><img src="<?php echo base_url() ?>assets/icons/start_process.png" title="Start" alt="Start" width="25" height="25"></a>
                                                        <?php 
                                                            }
                                                            else{
                                                        ?>
