                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                                if ($o['submit'] == 0) {
                                                                    if ($o['flow_id'] == $o['last'] && $o['batch'] < 1) {
                                                        ?>
                                                        <a href="<?php echo base_url('machine_flow/printing_complete/'.$o['id'].'/'.$o['flow_id'].'/'.$o['WO_no'].'/Yes') ?>"><img src="<?php echo base_url() ?>assets/icons/complete_process.png" title="Completed B_R" alt="Completed B_R" width="25" height="25"></a>
                                                        <?php }else{


                                                            ?>
                                                            <a href="<?php echo base_url('machine_flow/printing_complete/'.$o['id'].'/'.$o['flow_id'].'/'.$o['WO_no'].'/No') ?>"><img src="<?php echo base_url() ?>assets/icons/complete_process.png" title="Completed" alt="Completed" width="25" height="25"></a>
